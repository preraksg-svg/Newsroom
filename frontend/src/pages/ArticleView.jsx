  ...
  return (
    <div className="intelligence-terminal">
      ...
      <div className="terminal-body">
        ...
        {isSplitView && (
          <div className="terminal-content" style={{ flex: window.innerWidth > 768 ? '0 0 50%' : '1 1 auto', height: window.innerWidth > 768 ? '100%' : '500px', borderLeft: window.innerWidth > 768 ? '1px solid var(--color-border)' : 'none', borderTop: window.innerWidth > 768 ? 'none' : '1px solid var(--color-border)', background: '#080c10', display: 'flex', flexDirection: 'column', padding: 0 }}>
            {/* Header bar */}
